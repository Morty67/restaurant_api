...
SECRET_KEY = "django-insecure-u!w7o^51ird@^%zzg=t-pf)w!s!g!t4!i((p!&4o0f1v0kal1@"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_VERSION": "2.0",  # Specify the default version.,
    "ALLOWED_VERSIONS": ["1.0", "2.0"],  # List of allowed versions.
}
